...
import './tech/plugin.ts'
import '../PlayerCommon.css'

const NAME = 'VideoJS w/Shaka'
const COLOR = 'purple'
...
interface VideojsShakaProps {
  playbackUrl?: string | null
  licenseUrl?: string | null
}

export function VideojsShaka(props: VideojsShakaProps) {
  ...
  const create = async () => {
    player = videojs(videoRef, options, () => {
      // update video element ref because videojs replaces the video element
      videoRef = player.el_.querySelector('video')

      // add event listener on a new video element
